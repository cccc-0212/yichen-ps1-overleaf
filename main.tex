...
\newcommand{\GitHubLink}{\url{https://github.com/cccc-0212/yichen-ps1-overleaf} (code commit: \textbf{TODO after GitHub upload})}
\newcommand{\TemplateRepository}{\url{https://github.com/sunshineluyao/ps1-overleaf-template}}
\newcommand{\ColabLink}{\url{https://colab.research.google.com/github/cccc-0212/yichen-ps1-overleaf/blob/main/companion/notebooks/adaptive_tax_game.ipynb}}
